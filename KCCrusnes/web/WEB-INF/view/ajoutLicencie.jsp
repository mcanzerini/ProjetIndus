    ...
    <body>
        ...
        <div class="row-fluid">
            ...
            <div class="row">
                <div class="span2"></div>
                <div class="span6">
                    <form id="newLicencieForm" action="NewLicencie" enctype="multipart/form-data" method="POST" class="form-horizontal">
                        <div class="control-group">
                            <label class="control-label" for="inputNom">Nom</label>
                            <div class="controls">
                                <input type="text" name="nom" id="inputNom" /> <span class=" badge badge-info">Obligatoire</span>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" for="inputPrenom">Prénom</label>
                            <div class="controls">
                                <input type="text" name="prenom" id="inputPrenom"/> <span class=" badge badge-info">Obligatoire</span>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="villeNaissance" id="inputVilleNaissance"/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" for="inputNumRue">n° voie</label>
                            <div class="controls">
                                <input type="text" name="numRue" id="inputNumRue" class="input-small"/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" for="inputNomRue">Nom de la voie</label>
                            <div class="controls">
                                <input type="text" name="nomRue" id="inputNomRue"/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" for="inputCP">Code Postal</label>
                            <div class="controls">
                                <input type="text" name="CP" id="inputCP" class="input-small"/>
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="pays" id="inputPays"/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" for="inputTel">Téléphone</label>
                            <div class="controls">
                                <input type="text" name="telephone" id="inputTel"/> <span class=" badge badge-info">Obligatoire</span>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" for="inputSexe">Sexe</label>
                            <div class="controls">
                                <input type="radio" value="FEMININ" checked name="sexe"/> Féminin<br>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="numLicence" id="inputNumLicence"/> <span class=" badge badge-info">Obligatoire</span>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" for="inputStatut">Statut</label>
                            <div class="controls">
                                <input type="radio" value="true" checked name="actif"/> Actif<br>
                                <input type="radio" value="false" name="actif"/> Non Actif
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" for="inputPoids">Poids</label>
                            <div class="controls">
                                <input id="inputPoids" name="poids" type="number" class="input-small">
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label" for="inputEtudiant">Étudiant</label>
                            <div class="controls">
                                <input type="radio" value="false" checked name="etudiant" /> Non<br>
                                <input type="radio" value="true" name="etudiant" /> Oui
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select id="inputGrade" name="grade">
                                    <option selected="" value="CEINTURE_BLANCHE">Ceinture blanche</option>
