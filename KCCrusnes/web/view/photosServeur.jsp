        ...
        <div class="row-fluid">
            ...
            <div class="span7">
                <div class="page-header">
                    <h1>Photos Uploadées sur le serveur :</h1>
                </div>
            ...
            <div id="containeurPhotos" class="container">
                <s:form action="uploadFile"
                    ...
                    <s:submit cssClass="btn btn-primary" value="Valider" name="submit" />

                </s:form>
                <s:iterator value="files" var="file" status="photosStatus">
                    <s:if test="#photosStatus.index % 3 == 0">
                        <div class="row">
                            <ul class="thumbnails">
                            </s:if>
                            <li class="span4">
                                <a href='<s:url value="resources/img/%{file}"/>' rel="group" class="fancybox thumbnail">
                                    <img src='<s:url value="resources/img/%{file}"/>' data-src="holder.js/300x200" alt="">
                                </a>
                            </li>
