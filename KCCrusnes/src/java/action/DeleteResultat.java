 ...
 */
public class DeleteResultat extends ActionSupport {
    ...
    public String execute() throws NotLoggedException {
        ...
        if (session.get("logined") != null && session.get("logined").equals("true")) {
            ...
            Resultat deleteResultat = resultatDao.find(idResultatInt);
            resultatDao.delete(deleteResultat);
            resultats = resultatDao.findByCompet(deleteResultat.getCompetition().getId());
